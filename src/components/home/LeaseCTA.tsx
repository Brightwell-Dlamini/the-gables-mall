  ...
  return (
    <section className="relative py-24 sm:py-32 overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto px-4 text-center text-white">
        ...
        <Link
          href="/contact"
          className="inline-block px-10 py-4 rounded-full bg-white text-[#00b074] font-bold hover:bg-[#17ff49] hover:text-slate-900 transition-all duration-300 shadow-2xl hover:scale-105"
        >
          Enquire now
        </Link>
      </div>
