      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
          {anchors.map((b) => (
            <div
              key={b.name}
              className="bg-[var(--background)] rounded-2xl p-6 sm:p-8 flex items-center justify-center h-28 sm:h-32 border border-[var(--border)] hover:border-[#00b074]/50 transition-all hover:shadow-lg"
            >
              <Image
        ...
        <div className="text-center mt-12">
          <Link
            href="/directory"
            className="inline-flex px-8 py-3.5 rounded-full border-2 border-[#00b074] dark:border-[#17ff49] text-[#00b074] dark:text-[#17ff49] font-semibold hover:bg-[#00b074] hover:text-white dark:hover:bg-[#17ff49] dark:hover:text-slate-900 transition-all"
          >
